...
export const MEMBERSHIP_PLANS: Plan[] = [
  ...
  },
  {
    ...
    featuresMr: [
      ...
      'पूर्ण गोपनीयता नियंत्रण व अधिकृत व्हेरीफाईड बॅज गॅरंटी',
...
export const INITIAL_HERO_SLIDES: any[] = [
  ...
  },
  {
    ...
    subtitle: 'सुरक्षित व ॲडमिनद्वारे तपासणी केलेले वंजारी प्रोफाईल्स'
  },
  {
    id: 'slide-3',
...
export const INITIAL_COUNTERS: any[] = [
  ...
  { id: 'c-4', label: 'Verification Rate', labelMr: 'सुरक्षितता व पडताळणी', value: '१००%', iconName: 'ShieldCheck' }
];
...
export const INITIAL_SITE_CONFIG: any = {
  ...
  logoUrl: '/vanjari-jodi-official-logo.png?v=20260926-user',
  logoHeight: 52,
  ...
  tickerText: '📢 विशेष घोषणा: वंजारी जोडी वधू-वर मेळावा २०२६ नोंदणी सुरू आहे! सर्व प्रोफाईल्स पडताळणी व तपासणी केलेले आहेत.',
  ...
  regOption2Icon: '📁',
  bhagwangadImg: '/vanjari-jodi-official-logo.png',
