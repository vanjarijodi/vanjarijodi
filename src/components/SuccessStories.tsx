...
export const SuccessStories: React.FC = () => {
  ...
  return (
    <section id="success-stories-section" className="py-20 bg-slate-950 border-t border-amber-500/20 text-white relative overflow-hidden w-full max-w-full">
                      ...
                      <input
                        ...
                        onChange={async (e) => {
                          ...
                          if (file) {
                            ...
                            try {
                              const res = await uploadImageWithRetry(file, 'story');
                              if (res.success && res.url) {
                                setImageUrl(res.url);
                              } else {
                                setStoryImageError(res.errorMr || res.error || 'फोटो अपलोड अयशस्वी.');
                              }
                            } catch {
                              setStoryImageError('फोटो अपलोड करताना अडचण आली.');
                            } finally {
