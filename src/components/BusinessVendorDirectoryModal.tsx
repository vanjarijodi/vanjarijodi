...
export const BusinessVendorDirectoryModal: React.FC<{
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-0 sm:p-4 bg-slate-950/85 backdrop-blur-md overflow-hidden pt-safe pb-safe">
      <div className="relative w-full h-full sm:h-auto max-w-5xl bg-slate-900 border-0 sm:border border-amber-500/30 rounded-none sm:rounded-3xl shadow-2xl text-white overflow-hidden sm:my-auto max-h-none sm:max-h-[92vh] flex flex-col">
