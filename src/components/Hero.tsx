...
export const Hero: React.FC = () => {
  ...
  return (
    <div className="relative py-4 sm:py-6 overflow-hidden bg-gradient-to-b from-[#FDFBF7] via-[#FFFDF9] to-[#F8F9FA] text-slate-800 border-b border-amber-200/80">
      
      {/* Background Subtle Ambience */}
      <div className="absolute inset-0 pointer-events-none opacity-40 z-0 overflow-hidden">
        <div className="absolute -top-24 -left-24 w-80 h-80 rounded-full bg-blue-400/10 blur-3xl" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6 sm:space-y-8">
        ...
        {/* ========================================================================= */}
        <div className="w-full bg-gradient-to-br from-[#0A3258] via-[#6B0818] to-[#42040D] text-white rounded-2xl sm:rounded-3xl p-5 sm:p-7 shadow-2xl border-2 border-amber-400/60 relative overflow-hidden text-left glow-maroon">
          {/* Radiant background glows */}
          <div className="absolute -right-12 -bottom-12 w-72 h-72 rounded-full bg-amber-400/20 pointer-events-none blur-3xl" />
          <div className="absolute -left-12 -top-12 w-72 h-72 rounded-full bg-sky-400/15 pointer-events-none blur-3xl" />
          
          <div className="relative z-10 space-y-3.5 sm:space-y-4">
            
            {/* Top Badges */}
            <div className="flex items-center gap-2 flex-wrap">
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-black/50 backdrop-blur-md border border-amber-300/60 text-amber-200 text-xs font-black shadow-md">
                <CheckCircle2 className="w-3.5 h-3.5 text-emerald-400" />
                <span>{isEn ? 'Official Vanjari Portal' : 'महाराष्ट्र - अधिकृत वंजारी समाज सेवा'}</span>
              </span>

              <span className="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-amber-400/25 text-amber-200 border border-amber-300/60 text-[11px] font-black shadow-xs">
            ...
            <div>
              <h1 className="text-2xl sm:text-3xl md:text-4xl font-black tracking-tight text-white leading-tight drop-shadow-md">
                {isEn ? 'Vanjari Jodi Matrimony Portal' : 'वंजारी जोडी वधू-वर सूचक केंद्र'}
              </h1>
              <p className="text-amber-100 text-xs sm:text-sm font-medium mt-2 leading-relaxed max-w-2xl drop-shadow-xs">
                {isEn
            ...
            {currentUser && (
              <div className="flex flex-wrap items-center gap-2.5 pt-1">
                <button
                  ...
                  className="px-4 py-2.5 rounded-xl bg-gradient-to-r from-amber-400 via-amber-300 to-amber-500 hover:from-amber-300 hover:to-amber-400 text-slate-950 font-black text-xs sm:text-sm shadow-lg flex items-center gap-2 transition-all active:scale-95 cursor-pointer ring-1 ring-amber-300"
                >
                ...
                <button
                  ...
                  className="px-4 py-2.5 rounded-xl bg-white/20 hover:bg-white/30 border border-white/40 text-white font-black text-xs sm:text-sm shadow-sm flex items-center gap-2 transition-all active:scale-95 cursor-pointer backdrop-blur-xs"
                >
            ...
            {/* Trust Pill Bar */}
            <div className="flex items-center gap-3 pt-2 text-[10.5px] sm:text-xs text-amber-200 font-bold border-t border-white/20">
              <span className="flex items-center gap-1"><ShieldCheck className="w-4 h-4 text-emerald-300" /> सुरक्षित व पडताळणीकृत प्रोफाईल्स</span>
        ...
        {!currentUser ? (
          ...
          <div className="w-full bg-gradient-to-br from-[#FFFDF9] via-[#FFFBF2] to-[#FFF5E6] border-2 border-amber-300/90 rounded-3xl p-5 sm:p-7 shadow-lg text-center space-y-4 relative overflow-hidden">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#7A0C1E] to-[#9B111E] text-amber-300 flex items-center justify-center mx-auto shadow-md border border-amber-400/40">
              <ShieldCheck className="w-8 h-8" />
            </div>

            <div>
              <span className="inline-block px-3.5 py-0.5 rounded-full bg-amber-200/90 text-amber-950 text-[11px] font-black tracking-wider uppercase mb-1.5 border border-amber-300 shadow-2xs">
                🔒 प्रवेश आवश्यक
              </span>
              <h2 className="text-lg sm:text-2xl font-black text-[#7A0C1E] leading-snug tracking-tight">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 max-w-md mx-auto pt-2">
              <button
                ...
                className="py-3.5 px-4 rounded-2xl bg-gradient-to-r from-[#7A0C1E] via-[#9B111E] to-[#7A0C1E] hover:brightness-110 text-amber-100 font-black text-xs sm:text-sm shadow-md flex items-center justify-center gap-2 cursor-pointer transition active:scale-95 border border-amber-400/50 ring-1 ring-amber-300/30"
              >
