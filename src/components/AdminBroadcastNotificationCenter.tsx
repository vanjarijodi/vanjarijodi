...
export const AdminBroadcastNotificationCenter: React.FC = () => {
  ...
  const handleTestDevicePush = () => {
    ...
    if (!success && permissionState !== 'granted') {
      setSentSuccess('कृपया आधी वरील "पुश नोटिफिकेशन्स परवानगी द्या" बटणावर क्लिक करा.');
    }
  };
  ...
  const handleSendBroadcast = async (e: React.FormEvent) => {
    ...
    if (!title.trim() || !message.trim()) {
      setSentSuccess('कृपया शीर्षक आणि संदेश दोन्ही प्रविष्ट करा.');
      return;
    }
    ...
    try {
      ...
      console.error(err);
      setSentSuccess('ब्रॉडकास्ट पाठवताना त्रुटी आली. कृपया पुन्हा प्रयत्न करा.');
    } finally {
      setIsSending(false);
    }
  };
