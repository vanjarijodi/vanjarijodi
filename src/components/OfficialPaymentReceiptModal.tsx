    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-3 sm:p-5 bg-slate-900/80 backdrop-blur-md overflow-y-auto animate-fadeIn">
      <div className="bg-white rounded-3xl shadow-2xl border-2 border-amber-400 max-w-2xl w-full my-auto overflow-hidden relative text-slate-800">
        ...
        <div className="bg-gradient-to-r from-[#800C1E] via-[#A71930] to-[#5C0815] text-white p-5 sm:p-6 text-center relative border-b-4 border-amber-400">
          ...
          <div className="flex justify-center mb-2">
            <span className="px-3 py-1 rounded-full bg-amber-400/20 text-amber-300 border border-amber-400/40 text-[11px] font-black tracking-wide flex items-center gap-1.5 shadow-xs">
              ...
              <span>खाजगी नोंदणीकृत व्यासपीठ • डिजिटल सदस्यत्व पावती (Prime Multi Services)</span>
            </span>
          </div>
          ...
          <p className="text-xs text-amber-200/90 font-semibold mt-0.5">
            डिजिटल पेमेंट पावती व सदस्यत्व तपशील (Private Matrimonial Service)
          </p>
        ...
        <div className="p-5 sm:p-7 space-y-6 bg-slate-50/50">
          ...
          {/* Digital Signature & Private Merchant Verification */}
          <div className="bg-amber-50 rounded-2xl p-4 border border-amber-300/80 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <div className="w-14 h-14 rounded-full bg-gradient-to-br from-amber-500 to-amber-700 text-white flex items-center justify-center font-bold text-center text-[10px] leading-tight shadow-md border-2 border-white shrink-0">
                डिजिटल<br />पावती<br />प्रमाणित
              </div>
              <div>
                <h5 className="text-xs font-extrabold text-amber-950">Prime Multi Services (वंजारी जोडी) डिजिटल पडताळणी</h5>
                <p className="text-[11px] text-amber-900/80 font-medium">
                  मर्चंट: Prime Multi Services and Suppliers | Support: {senderEmail}
                </p>
              </div>
            </div>
            ...
            <div className="text-center sm:text-right shrink-0">
              ...
              <span className="text-[10px] font-mono font-bold text-slate-500">DIGITAL RECEIPT</span>
            </div>
          </div>
          ...
          <div className="bg-slate-100 rounded-xl p-3 border border-slate-200 text-[11px] text-slate-600 leading-relaxed space-y-1">
            <p className="font-bold text-slate-800 flex items-center gap-1">
              ...
              <span>कायदेशीर अस्वीकरण (Non-Government Independent Platform Disclaimer):</span>
            </p>
            <p className="italic">
              "वंजारी जोडी (Prime Multi Services) हे एक स्वतंत्र व खाजगी डिजिटल वधू-वर सूचक व्यासपीठ आहे. हे व्यासपीठ कोणत्याही शासकीय विभाग, सरकारी संस्था, मंत्रालय किंवा सार्वजनिक प्राधिकरणाशी संलग्न, प्रायोजित किंवा अधिकृत नाही. विवाह निश्चितीपूर्वी किंवा कोणत्याही आर्थिक व्यवहारापूर्वी कुटुंबीयांनी सर्व माहितीची प्रत्यक्ष खात्री करावी."
            </p>
          </div>
