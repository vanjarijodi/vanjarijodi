          ...
          <div className="space-y-6 text-center lg:text-left max-w-2xl">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-left">
              ...
              <div className="p-3 bg-white/10 backdrop-blur-md rounded-2xl border border-amber-300/20 flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-extrabold text-amber-200 text-xs sm:text-sm">सुरक्षित व विश्वासार्ह व्यासपीठ</h4>
                  <p className="text-[11px] text-amber-100/80">समाजातील पडताळणी पर्याय उपलब्ध असलेली वंजारी स्थळे.</p>
                </div>
              </div>
