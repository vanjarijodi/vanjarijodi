...
import { ShieldAlert, Send, Users, Building, ShieldCheck } from 'lucide-react';
        ...
        <div className="pt-2 flex flex-wrap items-center justify-between gap-2 text-[10.5px] text-amber-200/60 border-t border-amber-400/10">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="px-3 py-1.5 rounded-xl bg-amber-400 hover:bg-amber-300 text-slate-950 font-black text-xs shadow-md border border-amber-200 flex items-center gap-1.5 transition active:scale-95 cursor-pointer"
            >
              <ShieldCheck className="w-4 h-4 text-slate-950" />
              <span>👑 {isEn ? 'Admin Login' : 'प्रशासक लॉगिन'}</span>
            </button>
          </div>
        </div>
      </div>
