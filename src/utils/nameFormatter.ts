...
export function formatProfileDisplayName(
  ...
  // 2. GUEST USERS: Strictly surname only ("गेस्ट लॉगिनला फक्त आडनाव दिसले पाहिजे")
  ...
  // 3. PRIMARY RULE: "सदस्यांचे फक्त आडनाव दिसले पाहिजे, नाव दिसायचे असेल तर ॲडमिनने सेटिंगमधून टिक केल्यावरच नाव दिसले पाहिजे"
  ...
  // 4. Strict Unapproved Member Mode: Mask name until admin approves
